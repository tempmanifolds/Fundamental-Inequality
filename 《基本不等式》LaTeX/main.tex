...
% ---- 第一部分：题目区 ----
\input{sections/01-block1}
\input{sections/02-block2}
\input{sections/03-block3}
\input{sections/04-block4}
\input{sections/05-block5}
\input{sections/06-homework}     % 课后练习：做「自总结版」时整行注释
\input{sections/07-extensions}   % 拓展阅读（选读）：可整行注释

\clearpage
% ---- 第二部分：集中解析（与题目区物理分开）----
\input{sections/90-solutions}
\input{sections/91-homework-solutions}

% ---- 方法一览（自总结版可注释）----
\input{sections/99-summary}
