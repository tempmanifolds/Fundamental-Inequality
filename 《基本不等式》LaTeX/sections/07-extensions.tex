...
\textbf{例（书例 1.2-9）}　$a,b,c>0$，$abc=1$，证明 $(a+b)^3+(b+c)^3+(c+a)^3\ge 24$。
...
\block{拓展 B \starred\starred　用一个函数统一四个平均数}
...
\textbf{例（书例 1.2-8）}　正实数 $a,b$ 满足 $a+2b=2$，求 $\dfrac{1+4a+3b}{ab}$ 的最小值。
...
\textbf{对称猜测失效的例子。}（书例 1.3-5）$a,b>0$，$ab=1$，求 $\dfrac{1}{2a}+\dfrac{1}{2b}+\dfrac{8}{a+b}$ 的最小值。
